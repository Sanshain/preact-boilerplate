...
(See https://redux.js.org/faq/organizing-state#can-i-put-functions-promises-or-other-non-serializable-items-in-my-store-state)`);
	...
	var incremented = (_a = counterSlice.actions, _a.incremented); _a.decremented;
	...
	function Title() {
	    ...
	    var count = useStateSelector(function (state) { return state.value; });
	...
	var App = function (_a, context) {
	    ...
	    console.log(context);
	    return (u(k$2, { children: u("main", { children: [u("h1", { className: style.title, children: [nameTitle, "!!"] }), u("p", { children: [u("h4", { style: { color: 'blueviolet' }, children: "Ready to build something amazing?" }), u(Title, {}), u("button", { onClick: function () { return dispatch(incremented()); }, children: "increment" }), u("hr", {}), u("a", { href: "https://github.com/natemoo-re/microsite/tree/main/docs", children: "Read the docs" }), " to get started."] })] }) }));
	};
