...
(function () {
	...
	***************************************************************************** */
	...
	const Home = () => {
	  ...
	  return _$1("div", {
	    class: style$1.home
	  }, _$1("h1", null, "Home"), _$1("p", null, "This is the Home component."), _$1("input", {
	    ref: inputRef,
	...
	var style = {"profile":"style_profile__vbewj","user_point":"style_user_point__R8l0V"};
	...
	const Profile = ({
	  ...
	  }, "Click Me"), ' ', "Clicked ", count, " times."), user == 'me' ? _$1("p", null, _$1("br", null), _$1("h4", null, "User list:"), _$1("ul", null, users.map(u => {
	    return _$1("li", {
	      class: style.user_point
	    }, _$1(Link$1, {
	      href: "/profile/" + u
	    }, u));
	  }))) : '');
